...
#Settings for window size; the sidebar has hardcoded positions of UI elements => they may not render correctly when these settings change. If you have less than 1920x1080 resolution I recommend setting widthGrid and heightGrid to 700
width_menu = 300
